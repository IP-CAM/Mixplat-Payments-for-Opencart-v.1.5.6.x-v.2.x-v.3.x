      ...
      <div class="panel-body">
        ...
        <tr>
          ...
          <td><?php if ($mixplatpro_name_attach) { ?>
            ...
            <span class="hidename" <?php if (!$mixplatpro_name_attach) {?>style="display:none;"<?php } ?>><?php foreach ($languages as $language) { ?><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="<?php echo $pname; ?>_name_<?php echo $language['language_id']; ?>" cols="50" rows="1"><?php echo isset(${'mixplatpro_name_' . $language['language_id']}) ? ${'mixplatpro_name_' . $language['language_id']} : ''; ?></textarea>
